    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-orange-50 flex items-center justify-center p-6">
      <Card className="w-full max-w-2xl shadow-2xl border-2 border-construction/20 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-10 right-1/4 w-2 h-2 bg-blue-400 rounded-full animate-bounce" style={{ animationDelay: '0.2s' }}></div>
          <div className="absolute top-5 left-1/2 w-2 h-2 bg-orange-400 rounded-full animate-bounce" style={{ animationDelay: '0.4s' }}></div>
        </div>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-lg p-6 text-center">
            ...
            <p className="text-green-700">
              You now have access to all premium features. Start generating leads and closing deals!
            </p>
          </div>
          ...
          <div className="bg-slate-50 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-slate-700">AI Lead Qualification</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-construction rounded-full"></div>
                <span className="text-sm text-slate-700">WhatsApp Integration</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-construction rounded-full"></div>
              ...
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-construction rounded-full"></div>
                <span className="text-sm text-slate-700">Meeting Scheduling</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-construction rounded-full"></div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3 p-3 bg-slate-50 rounded-lg border-2 border-slate-200">
                ...
                <div>
                  <p className="font-medium text-slate-900">Set up your WhatsApp</p>
                  <p className="text-sm text-slate-600">Connect your business WhatsApp number</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 p-3 bg-slate-50 rounded-lg border-2 border-slate-200">
                ...
                <div>
                  <p className="font-medium text-slate-900">Add your first client</p>
                  <p className="text-sm text-slate-600">Create a client profile to start managing leads</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 p-3 bg-slate-50 rounded-lg border-2 border-slate-200">
                ...
                <div>
                  <p className="font-medium text-slate-900">Generate your first VSL</p>
                  <p className="text-sm text-slate-600">Create video sales letters to attract leads</p>
                </div>
              </div>
            </div>
          </div>
