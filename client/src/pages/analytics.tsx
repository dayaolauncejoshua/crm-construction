...
export default function Analytics() {
  ...
  }) as { data: { kpis?: any; analytics?: any[] } | undefined; isLoading: boolean };
    ...
    <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b border-slate-200 px-4 sm:px-6 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900">Analytics & Reporting</h2>
              <p className="text-sm sm:text-base text-slate-600">Track performance and optimize your lead generation</p>
            </div>
        ...
        <main className="flex-1 overflow-auto p-4 sm:p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{Math.floor(kpis.avgResponseTime / 60)}m {kpis.avgResponseTime % 60}s</div>
                <p className="text-xs text-muted-foreground">-23s from last month</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{kpis.aiHandledPercentage.toFixed(0)}%</div>
                ...
                {leadSourceData.map((source, index) => (
                  <Card key={source.name}>
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-muted-foreground">{source.value}% of total leads</p>
                    </CardContent>
                  </Card>
                ))}
              </div>
                    ...
                    <CardContent>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm text-muted-foreground">
                          Target: {typeof metric.target === 'number' && metric.target > 10 
                            ? `${metric.target}%` 
                            : metric.target
                          }
                        </span>
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div 
                          ...
                          style={{ 
                            width: `${typeof metric.value === 'number' && metric.value > 10 
