...
export default function VSL() {
  ...
  const createVSLMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/vsls", selectedClientId] });
      setShowCreateDialog(false);
      form.reset();
      toast({
        title: "Success!",
        description: "VSL script generated successfully. Video creation in progress...",
      });
    },
    onError: (error) => {
      toast({
        ...
        <header className="bg-white border-b border-slate-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-600">Create automated video sales letters for your clients</p>
            </div>
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="e.g., Construction Lead Generation VSL" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                        ...
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="agency">Marketing Agencies</SelectItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="e.g., Construction company owners with 10-50 employees" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <div className="flex justify-end space-x-3 pt-4">
                      ...
                      >
                        {createVSLMutation.isPending ? "Generating..." : "Generate VSL"}
                      </Button>
                    </div>
                  </form>
                </Form>
        ...
        <main className="flex-1 overflow-auto p-6">
          {vsls?.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">No VSLs Created Yet</h3>
              <p className="text-slate-600 mb-6">Generate your first AI-powered video sales letter</p>
              <Button 
                ...
                <Card key={vsl.id} className="hover:shadow-md transition-shadow">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {vsl.videoUrl ? (
                      ...
                      <div className="aspect-video bg-slate-100 rounded-lg flex items-center justify-center">
                        <div className="text-center">
                          ...
                          <p className="text-sm text-slate-600">Generating video...</p>
                        </div>
                      </div>
                    )}
                    ...
                    <div className="grid grid-cols-3 gap-3 text-center">
                      <div>
                        <div className="text-lg font-semibold text-slate-900">{vsl.viewCount || 0}</div>
                    ...
                    {vsl.script && (
                      <div className="bg-slate-50 rounded-lg p-3">
                        <h4 className="text-sm font-medium text-slate-900 mb-2">Script Preview</h4>
