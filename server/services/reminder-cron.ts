    ...
    for (const client of clients) {
      try {
        ...
        for (const booking of bookings) {
          ...
          // Send 24-hour reminder (between 23.75 and 24.25 hours before)
          // Wider window to ensure we catch it within our 15-min check interval
          if (
          ...
          // Send 1-hour reminder (between 0.75 and 1.25 hours before)
          if (
